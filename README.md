...
region = <your_preferred_region> # when called with --profile, the region will be appended to credentials with the profile.
app = <AWS application name> # (optional), for example: Amazon Web Services
```
